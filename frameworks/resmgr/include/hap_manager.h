...
public:
    ...
    */
     ...
     */
    virtual RState GetResConfigById(uint32_t resId, ResConfig &resConfig,
     ...
     * @return SUCCESS if config exist, else NOT_FOUND
     */
    virtual RState GetResConfigByName(const std::string &name, const ResType type, ResConfig &resConfig,
        bool isGetOverrideResource = false, uint32_t density = 0);
