...
#ifndef THEME_MANAGER_TEST_H
#define THEME_MANAGER_TEST_H
...
int ThemeManagerTestIsSameResourceByUserIdTest002(void);
int ThemeManagerTestIsSameResourceByUserIdTest003(void);
